...
<template>
  <div class="button-group">
    <div class="button" @click="windowStore.windowMinimize">
    ...
    <div class="button" title="最大化" @click="windowStore.windowMaximize">
      <svg class="icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
        <path
    ...
    <div class="button" title="关闭应用" @click="windowStore.windowClose">
      <svg class="icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
        <path
